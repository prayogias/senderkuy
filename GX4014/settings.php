...
*/
	...
	$smtpuser = "jawa@igooy.com";		// Required

	$smtppass = "prayogi1234";		// Required
	...
	$mailist = "target/asss.txt";		//	Isi nama file mailist kamu
	...
	$fromname = "SENDER NAME";		// Kosongkan jika menggunakan random fitures Secure@apple.com

	$frommail = "SENDER MAIL";		// Kosongkan jika menggunakan random fiture 

	$subject = "SUBJECT";		// Kosongkan jika menggunakan random fiture
